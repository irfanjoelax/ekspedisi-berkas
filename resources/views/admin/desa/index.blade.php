...
@section('content')
    <div class="row mt-4">
        <div class="col-md-12">
            <a href="{{ url('admin/desa/create') }}" class="btn btn-primary mb-3">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                        <a href="{{ url('/admin/desa/edit/' . $item->id) }}" class="btn btn-warning">
                                            Ubah
                                        </a>
                                        <a onclick="return confirm(`Apakah yakin ingin menghapus data berikut ini?`)"
                                            href="{{ url('/admin/desa/delete/' . $item->id) }}" class="btn btn-danger">
                                            Hapus
                                        </a>
                                    </div>
                                </td>
